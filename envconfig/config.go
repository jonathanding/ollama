...
var (
	...
	// memory (cudaMallocHost) so the GPU can DMA them at full PCIe bandwidth
	// (~25 GB/s vs ~14 GB/s pageable). Mirrors llama.cpp's make_cpu_buft_list
	// behavior. Default: disabled (opt-in). Set OLLAMA_PINNED_HOST_BUFFER=1
