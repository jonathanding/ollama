...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_SSM_ATTN_QKV,                          "blk.%d.attn_qkv" },
    { LLM_TENSOR_SSM_ATTN_GATE,                         "blk.%d.attn_gate" },
    ...
    switch (arch) {
        ...
        case LLM_ARCH_QWEN3NEXT:
            return {
                ...
                LLM_TENSOR_SSM_IN,
                LLM_TENSOR_SSM_ATTN_QKV,
                LLM_TENSOR_SSM_ATTN_GATE,
                LLM_TENSOR_SSM_NORM,
                LLM_TENSOR_SSM_OUT,
            };
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_SSM_ATTN_QKV,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_SSM_ATTN_GATE,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
